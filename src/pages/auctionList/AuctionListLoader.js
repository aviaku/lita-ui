...
const AuctionListLoader = ({ ...props }) => {
  const [windowSize, setWindowSize] = useState(getWindowSize());

  const width = windowSize.innerWidth > 1023 ? 1100 : windowSize.innerWidth;
...
export default AuctionListLoader;
