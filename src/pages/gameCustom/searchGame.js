...
function Games(props) {
  ...
  const gameList = () => {
    console.log("props.gameUser", props.gameUser);
  ...
  return (
    <Layout>
      <section className="flat-title-page" style={{ padding: "180px 0 150px" }}>
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <div className="flex" style={{ justifyContent: "center" }}>
                <span className="text-color h2">Search result for "{searchText}"</span>
              </div>
            </div>
          </div>
        </div>
